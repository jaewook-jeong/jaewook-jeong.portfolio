...
import { User, Briefcase, GitHub, Search, Feather } from 'react-feather'
    ...
    <div className="container">
      <NavbarElement>
          <NavbarLogo>
            <h3>
              <Link to="/">
                <Search className="align-middle"/> <span className="align-middle"> {siteTitle} </span>
              </Link>
            </h3>
          </NavbarLogo> 
          <div className="main-navigation">
            <NavbarList>
              ...
              <li><Link to="https://velog.io/@_woogie" className="lined-link" activeClassName="active"> <Feather /> <span> Blog </span> </Link></li>  
            </NavbarList>
          </div>
      </NavbarElement>
    </div>
